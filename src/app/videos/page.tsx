    ...
    <>
      <section className="relative h-64 sm:h-80 overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6 pt-20">
          <p className="text-[#f45235] text-[10px] tracking-[0.4em] uppercase mb-4">See the Space</p>
      ...
      <section className="py-20 px-6 lg:px-8 max-w-6xl mx-auto space-y-16">
        ...
        {VIDEOS.length === 0 && EMBEDS.length === 0 && (
          <p className="text-center text-foreground/50">Video tours coming soon. <a href="/contact" className="text-[#f45235] hover:underline">Contact us</a> to schedule an in-person tour.</p>
        )}
      </section>
    </>
  );
