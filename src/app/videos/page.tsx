      ...
      <section className="py-20 px-6 lg:px-8 max-w-6xl mx-auto space-y-16">
            ...
            <div className="grid gap-10">
              {EMBEDS.map((embed) => (
                <div key={embed.id} className="space-y-4">
                  <h3 className="text-center text-sm tracking-[0.2em] uppercase text-foreground/50">
                    {embed.title}
                  </h3>
                  <div
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {VIDEOS.map((video) => (
                <div key={video.id} className="space-y-3">
                  <h3 className="text-sm tracking-[0.15em] uppercase text-foreground/50">
                    {video.title}
                  </h3>
        ...
        {VIDEOS.length === 0 && EMBEDS.length === 0 && (
          <p className="text-center text-foreground/50">
            ...
            <a href="/contact" className="text-[#f45235] hover:underline">
              Contact us
            </a>{' '}
