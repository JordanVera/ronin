      ...
      <div className="max-w-5xl mx-auto">
        <div className="grid md:grid-cols-[1fr_2fr] gap-12 md:gap-16 items-start">
          <motion.div {...anim(0)} className="flex flex-col gap-4">
            <span className="text-[#f45235] text-[10px] tracking-[0.35em] uppercase">
              Welcome
            </span>
            <div className="h-px w-16 bg-[#f45235]" />
          ...
          <div className="flex flex-col gap-6">
            ...
            >
              ...
              <em className="italic text-[#f45235]">memorable celebrations.</em>
            </motion.h2>
